...
public class ProductoControlador {
    ...
    public void borrarProductoPorNombre(@PathVariable("nombre") String nombre){
    ...
    public Productos actualizarProductoPorId(@PathVariable("productId")int id, @RequestBody Productos producto){
        return productosServicio.actualizarProductoPorId(id,producto);
    }
